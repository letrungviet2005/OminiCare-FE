...
import { ArrowUpDown, ArrowUp, ArrowDown, MoreHorizontal, ChevronRight } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export function AlertTable({
  ...
  const SortableHead = ({ k, children, className }: { k: AlertSortKey; children: React.ReactNode; className?: string }) => (
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-slate-200/10 bg-card shadow-sm dark:border-slate-800">
                  ...
                  return (
                    <TableRow
                      ...
                      className={cn(
                        ...
                        alert.status === 'new' && 'before:absolute before:left-0 before:top-2 before:bottom-2 before:w-[3px] before:bg-blue-500'
                      )}
                    >
                      ...
                      <TableCell className="text-center">
                        ...
                        >
                          <span className={cn('h-1.5 w-1.5 rounded-full', riskConf.dot, alert.riskLevel === 'HIGH' && 'animate-pulse')} />
                          {riskConf.label}
                        </span>
                      </TableCell>
